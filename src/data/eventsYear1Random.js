export const randomEventsYear1 = [
    {
        id: "r1",
        title: "Nhức não với quá nhiều Toán",
        description: "Giờ học toán thường xuyên ngập trong những định thức, ma trận và dãy số dài dằng dặc.",
        choices: [
            {
                id: "r1_c1",
                title: "Đánh một giấc",
                content: "Bạn thấy bạn bè quanh bạn đang ngủ say sưa, bạn cũng gục mặt xuống bàn làm một giấc ngon lành.",
                tech: -2,
                art: 0,
                outcome: "Bạn có một giấc ngủ ngon, nhưng kiến thức bị hổng, và kỳ thi giữa kỳ sắp đến gần."
            },
            {
                id: "r1_c2",
                title: "Hí hoáy vẽ",
                content: "Bạn nhìn quanh và thấy cô giảng viên đang say sưa giải thích định thức trên bảng, bạn nhân cơ hội lôi giấy ra vẽ phác thảo cô.",
                tech: -1,
                art: 2,
                outcome: "Vở viết đày những bức phác thảo, chỉ tiếc là trong đầu bạn không đọng lại bất kỳ công thức toán nào."
            },
            {
                id: "r1_c3",
    ...
    {
        id: "r2",
        title: "Sự cố \"màn hình đen\"",
        description: "Chiếc điện thoại của bạn bỗng dưng sập nguồn đen ngòm và đơ cứng sau một đợt tự động cập nhật hệ điều hành.",
        choices: [
            {
                id: "r2_c1",
                title: "Mang ra tiệm sửa",
                content: "Đành chấp nhận mất tiền mang máy ra trung tâm bảo hành hoặc cửa hàng sửa chữa để thợ lo liệu.",
                tech: -1,
                art: 0,
                outcome: "Chiếc điện thoại đã hồi sinh, nhưng ví tiền của bạn bị hụt một khoản kha khá mà bản thân chẳng học hỏi thêm được chút kiến thức nào."
            },
            {
                id: "r2_c2",
                title: "Tự mày mò \"cứu hộ\"",
                content: "Lên các diễn đàn công nghệ, tải công cụ và tự tìm cách flash lại ROM gốc cho máy.",
                tech: 2,
                art: -1,
                outcome: "Mất cả đêm toát mồ hôi hột lo sợ máy hỏng hẳn, cuối cùng màn hình cũng sáng lại."
            },
            {
                id: "r2_c3",
    ...
    {
        id: "r3",
        title: "Kiến trúc máy chủ game",
        description: "Nhóm bạn thân chơi trong server Minecraft đang cần một dự án ấn tượng để biểu diễn trong buổi lễ hội sắp tới của trường.",
        choices: [
            {
                id: "r3_c1",
    ...
    {
        id: "r4",
        title: "Trạm game Teambuilding",
        description: "Bạn được Ban tổ chức câu lạc bộ tin tưởng giao nhiệm vụ thiết kế trạm thử thách cho đợt chào đón sinh viên khóa mới.",
        choices: [
            {
                id: "r4_c1",
    ...
    {
        id: "r5",
        title: "Bài tập thuyết trình nhóm",
        description: "Bài tập lớn của môn tự chọn yêu cầu thiết kế một slide thuyết trình. Tuy nhiên, các thành viên trong nhóm đang đùn đẩy nhau vì ai cũng lười thiết kế.",
        choices: [
            {
                id: "r5_c1",
                title: "Dùng mẫu có sẵn cho nhanh",
                content: "Lên Canva tải một template miễn phí bất kỳ, copy-paste nội dung vào cho xong nghĩa vụ.",
                tech: -1,
                art: -1,
                outcome: "Bài thuyết trình trông cực kỳ tẻ nhạt, chữ chồng chéo chữ khiến nhóm nhận về số điểm trung bình khá khiêm tốn."
            },
            {
                id: "r5_c2",
    ...
    {
        id: "r6",
        title: "Mục tiêu chứng chỉ ngoại ngữ",
        description: "Nhìn tấm bằng ra trường yêu cầu chuẩn đầu ra Tiếng Anh, bạn nhận ra mình cần bắt đầu kế hoạch ôn thi chứng chỉ ngay từ năm nhất.",
        choices: [
            {
                id: "r6_c1",
    ...
    {
        id: "r7",
        title: "Mê cung Giảng đường G",
        description: "Giờ học sắp bắt đầu nhưng bạn vẫn đang loay hoay trong hành lang lắt léo của tòa nhà G - nơi được mệnh danh là \"mê cung\" của trường đại học.",
        choices: [
            {
                id: "r7_c1",
                title: "Chạy dò từng phòng học",
                content: "Cứ thế chạy dọc khắp các tầng hành lang, hy vọng sẽ tình cờ nhìn thấy mã phòng học quen thuộc.",
                tech: -1,
                art: 0,
                outcome: "Chạy bở hơi tai và thở dốc, bạn bước vào lớp muộn 15 phút dưới ánh nhìn ái ngại của thầy cô và bạn bè."
            },
            {
                id: "r7_c2",
    ...
    {
        id: "r8",
        title: "Cơn bão \"Peer Pressure\"",
        description: "Lướt Facebook, bạn ngập chìm trong các bài đăng khoe GPA tuyệt đối, học bổng danh giá hay thành tích CLB khủng từ bạn bè đồng trang lứa.",
        choices: [
            {
                id: "r8_c1",
            ...
            {
                id: "r8_c2",
                title: "Biến áp lực thành động lực code",
                content: "Tự ái dâng cao, bạn đóng cửa phòng cày bài tập lập trình đến 3 giờ sáng để chứng minh năng lực.",
                tech: 2,
                art: -2,
                outcome: "Trình độ giải thuật của bạn có tiến bộ, nhưng cơ thể kiệt sức và tinh thần rơi vào trạng thái căng thẳng tột độ."
            },
            {
                id: "r8_c3",
    ...
    {
        id: "r9",
        title: "Quyết định đầu tư năm nhất",
        description: "Dành dụm được một khoản tiền tiêu vặt nhỏ, bạn muốn nâng cấp góc học tập tại phòng trọ để có thêm cảm hứng học tập.",
        choices: [
            {
                id: "r9_c1",
    ...
    {
        id: "r10",
        title: "Sự cố mạng đêm khuya",
        description: "Đang trong giờ cao điểm làm bài tập lớn lúc nửa đêm, mạng wifi của xóm trọ đột nhiên chập chờn rồi mất hẳn kết nối.",
        choices: [
            {
                id: "r10_c1",
                title: "Gác lại công việc, đi ngủ",
                content: "Coi như đây là tín hiệu vũ trụ bảo phải đi ngủ, tắt máy tính và leo lên giường nghỉ ngơi.",
                tech: -1,
                art: 0,
                outcome: "Bạn lỡ mất buổi leo rank game cùng bạn bè, nhưng đổi lại sáng hôm sau thức dậy với một tinh thần sảng khoái và tràn đầy năng lượng."
            },
            {
                id: "r10_c2",
